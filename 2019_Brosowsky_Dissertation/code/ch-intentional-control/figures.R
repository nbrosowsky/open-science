...
ggsave(filename="ICfigure2.pdf",device="pdf",path="../figures/",width = 3.5, height = 3, dpi = 600)
...
ggsave(filename="ICfigure3.pdf",device="pdf",path="../figures/",width = 5, height = 3, dpi = 600)
rm(E2_figure)
...
ggsave(filename="ICfigure4.pdf",device="pdf",path="../figures/",width = 5, height = 3, dpi = 600)
rm(E3_figure)
...
ggsave(filename="ICfigure5.pdf",device="pdf",path="../figures/",width = 6, height = 3, dpi = 600)
rm(E4_figure)
...
ggsave(filename="ICfigure6.pdf",device="pdf",path="../figures/",width = 6.5, height = 3, dpi = 600)
rm(E4_block_figure)
